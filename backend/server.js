...
app.get('/api/health', (req, res) => {
  res.json({
    ...
    ghl_key_prefix: GHL_API_KEY ? GHL_API_KEY.slice(0, 6) + '...' : null,
    ghl_location: GHL_LOCATION || null,
    supabase_configured: !!supabase,
    supabase_url: SUPABASE_URL ? SUPABASE_URL.slice(0, 30) + '...' : null,
    maps_configured: !!GMAPS_KEY,
    env_keys_found: Object.keys(process.env).filter(k =>
      k.startsWith('GHL_') || k.startsWith('SUPABASE_') || k.startsWith('GOOGLE_')
    ),
...
// Vercel serverless functions need module.exports, NOT app.listen().
